<div class="space-y-4">
    <div class="input-area">
        <label for="name" class="form-label">{{ __('Nama Role') }}</label>
        <input required name="name" type="text" value="{{ old('name', $role->name) }}"
    ...
    <div class="input-area">
        ...
        <input required name="guard_name" type="text" value="{{ old('guard_name', $role->guard_name) }}"
