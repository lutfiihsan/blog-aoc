                    ...
                    <footer class="card-footer">
                        <div class="card-footer-item">
                            <form action="{{ route('backend.users.reset.password', $user) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-sm btn-outline btn-primary flex items-center">
                                    {{ __('Reset Password') }}
                                </button>
                            </form>
                        </div>
                        <div class="card-footer-item">
                            <form action="{{ route('backend.users.destroy', $user) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-sm btn-outline btn-danger flex items-center">
                                    {{ __('Hapus Pengguna') }}
                                </button>
                            </form>
                        </div>
